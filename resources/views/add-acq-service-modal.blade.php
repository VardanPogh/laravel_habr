<div class="modal fade" id="fixedService5" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="fixedServiceAcqLabel">@lang('site.add') @lang('site.client')</h5>
            ...
            <div class="modal-body">
                <label for="fixedServiceName5" class="h4">@lang('site.services'): </label>
                <span id="fixedServiceName5" class="h4"></span>
                <form method="POST" id="form5" class="acqService">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <fieldset class="fieldset">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="tax_code" type="text" class="form-control" id="taxCodeInput"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="issue_date" type="date" class="form-control" id=""
                                               placeholder="Data emissione" onblur="changeDate()">
                            ...
                            <fieldset class="fieldset">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="new_sim_number">Inserire numero nuova SIM</label>
                                        <input name="new_sim_number" type="text" class="form-control" id=""
                                               placeholder="IInserire numero nuova SIM">
                                        <span id="new_sim_number" class="invalid-feedback"></span>
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="iccid_serial_sim">ICCID – Seriale Sim</label>
                                        <input name="iccid_serial_sim" type="text" class="form-control" id=""
                                               placeholder="ICCID – Seriale Sim">
                                        <span id="iccid_serial_sim" class="invalid-feedback"></span>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="iccid_serial_sim_2">ICCID 2 – Seriale Sim 2</label>
                                        <input name="iccid_serial_sim_2" type="text" class="form-control" id=""
                                               placeholder="ICCID – Seriale Sim 2">
                                        <span id="iccid_serial_sim_2" class="invalid-feedback"></span>
                                    </div>
                                </div>
                            </fieldset>
                        </div>
                ...
                <div class="progress">
                    <span id="progress5" class="badge bg-danger">55%</span>
                    <div id="progressProcent5" class="progress-bar progress-bar-danger" style="width: 0%"></div>
                </div>
            </div>


            <div class="modal-footer">
                <button type="button" onclick="addAcqTransaction()" class="btn btn-primary">Aggiungi</button>
            </div>
