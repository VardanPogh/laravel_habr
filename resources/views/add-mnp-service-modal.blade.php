<div class="modal fade" id="fixedService4" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="fixedServiceMnpLabel">@lang('site.add') @lang('site.client')</h5>
            ...
            <div class="modal-body">
                <label for="fixedServiceName4" class="h4">@lang('site.services'): </label>
                <span id="fixedServiceName4" class="h4"></span>
                <form method="POST" id="form4" class="mnpService">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <fieldset class="fieldset">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="current_mobile_operator">Operatore mobile attuale</label>
                                        <input name="current_mobile_operator" type="text" class="form-control" id=""
                                               placeholder="Operatore mobile attuale">
                                        <span id="current_mobile_operator" class="invalid-feedback"></span>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label for="temporary_tim_number">Numero provvisorio TIM</label>
                                        <input name="temporary_tim_number" type="number" class="form-control" id=""
                                               placeholder="Numero provvisorio TIM">
                                        <span id="temporary_tim_number" class="invalid-feedback"></span>
                                    </div>
                                </div>
                            </fieldset>
                        </div>
                ...
                <div class="progress">
                    <span id="progress4" class="badge bg-danger">55%</span>
                    <div id="progressProcent4" class="progress-bar progress-bar-danger" style="width: 0%"></div>
                </div>
            </div>


            <div class="modal-footer">
                <button type="button" onclick="addMnpTransaction()" class="btn btn-primary">Aggiungi</button>
            </div>
