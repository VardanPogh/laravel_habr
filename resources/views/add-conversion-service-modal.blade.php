<div class="modal fade" id="fixedService3" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="fixedServiceConversionLabel">@lang('site.add') @lang('site.client')</h5>
            ...
            <div class="modal-body">
                <label for="fixedServiceName3" class="h4">@lang('site.services'): </label>
                <span id="fixedServiceName3" class="h4"></span>
                <form method="POST" id="form3" class="ConversionService">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <fieldset class="fieldset">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="fixed_tim_number">Numero Tim Fisso</label>
                                        <input name="fixed_tim_number" type="number" class="form-control" id=""
                                               placeholder="Numero Tim Fisso">
                                        <span id="fixed_tim_number" class="invalid-feedback"></span>
                                    </div>
                                    <div class="form-group col-md-6">
                ...
                <div class="progress">
                    <span id="progress3" class="badge bg-danger">55%</span>
                    <div id="progressProcent3" class="progress-bar progress-bar-danger" style="width: 0%"></div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" onclick="addConversionTransaction()" class="btn btn-primary">Aggiungi</button>
            </div>
