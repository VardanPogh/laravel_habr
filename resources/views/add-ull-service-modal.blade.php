<div class="modal fade" id="fixedService1" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="fixedServiceUllLabel">@lang('site.add') @lang('site.client')</h5>
            ...
            <div class="modal-body">
                <label for="fixedServiceName1" class="h4">@lang('site.services'): </label>
                <span id="fixedServiceName1" class="h4"></span>
                <form method="POST" id="form1" class="ullService">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <fieldset class="fieldset">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="province" type="text" class="form-control" id=""
                            ...
                            <fieldset class="fieldset">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="current_manager">Gestore Attuale</label>
                                        <input name="current_manager" type="text" class="form-control" id=""
                                               placeholder="Gestore Attuale">
                                        <span id="current_manager" class="invalid-feedback"></span>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="migration_code">Codice di Migrazione</label>
                                        <input name="migration_code" type="text" class="form-control" id=""
                                               placeholder="Codice di Migrazione">
                                        <span id="migration_code" class="invalid-feedback"></span>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="current_landline_number">Numero di telefono fisso attuale</label>
                                        <input name="current_landline_number" type="number" class="form-control" id=""
                                               placeholder="Numero di telefono fisso attuale">
                                        <span id="current_landline_number" class="invalid-feedback"></span>
                                    </div>
                                    <div class="form-group col-md-6">
                ...
                <div class="progress">
                    <span id="progress1" class="badge bg-danger">55%</span>
                    <div id="progressProcent1" class="progress-bar progress-bar-danger" style="width: 0%"></div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" onclick="addUllTransaction()" class="btn btn-primary">Aggiungi</button>
            </div>
        </div>
    </div>
</div>
