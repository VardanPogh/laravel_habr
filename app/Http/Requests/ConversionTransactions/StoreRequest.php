...
namespace App\Http\Requests\ConversionTransactions;
...
class StoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'fixed_tim_number'              => 'required|string',
    ...
    public function persist(): self
    {
        ...
        $this->conversionService = ConversionTransaction::create(array_merge($this->request->all(), $this->getMergingData()));
    ...
    public function createFile()
    {
        if ($this->hasFile('document_retro')) {
            ...
            $fileName = time().'_conversion_transaction_document_retro_'.$nameOri;
            $file->move(public_path('Attachments/ConversionTransactionAttachments'), $fileName);
        ...
        if ($this->hasFile('document_front')) {
            ...
            $nameOri = join('_', explode(' ', $file->getClientOriginalName()));
            $fileName = time().'_conversion_transaction_document_front_'.$nameOri;
            $file->move(public_path('Attachments/ConversionTransactionAttachments'), $fileName);
            $this->documentFront = $fileName;
        }
    }

    public function getConversionService(): ConversionTransaction
    {
